...
auto run(int argc, char const* const* argv) -> int {
	...
	auto const args = std::array{
		clap::flag(debug, "d,debug", "print all parameters"),
		clap::option(symbol, "s,symbol", "multiplication symbol"),

		clap::positional(num_0, clap::ArgType::Required, "NUM_0", "integer 0"),
		clap::positional(num_1, clap::ArgType::Required, "NUM_1", "integer 1"),

		clap::list(nums, "NUM_N...", "other numbers"),
	};
